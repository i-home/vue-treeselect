...
/* harmony default export */ var MultiValuevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    renderSingleValueLabel: function renderSingleValueLabel() {
      var instance = this.instance;
      var nodes = instance.selectedNodes;
      var value = instance.value;
      var customValueLabelRenderer = instance.$scopedSlots.label;
      return customValueLabelRenderer && nodes.length > 0 ? customValueLabelRenderer({
        nodes: nodes,
        value: value
      }) : null;
    },
    renderValuesLabel: function renderValuesLabel() {
      var h = this.$createElement;
      var instance = this.instance;
      var customValueLabelRenderer = instance.$scopedSlots.label;
      return customValueLabelRenderer ? h("div", {
        "class": "vue-treeselect__single-value",
        key: "values-label"
      }, [this.renderSingleValueLabel()]) : this.renderMultiValueItems();
    }
  },
  render: function render() {
    var h = arguments[0];
    ...
    }, transitionGroupProps]), [this.renderValuesLabel(), this.renderExceedLimitTip(), h(Placeholder, {
      key: "placeholder"
    }), h(Input, {
      ref: "input",
      key: "input"
